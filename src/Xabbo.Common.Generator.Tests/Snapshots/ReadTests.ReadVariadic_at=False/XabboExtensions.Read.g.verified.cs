...
internal static partial class XabboExtensions
{
    ...
    /// <summary>
    /// Reads 3 values of the specified types from the current position in the packet.
    /// </summary>
    ...
    /// <summary>
    /// Reads 4 values of the specified types from the current position in the packet.
    /// </summary>
    ...
    /// </summary>
    public static (T1, T2, T3, T4, T5) Read<T1, T2, T3, T4, T5>(this global::Xabbo.Messages.IPacket p)
    {
        global::Xabbo.Messages.PacketReader r = p.Reader();
    ...
    /// </summary>
    public static (T1, T2, T3, T4, T5, T6) Read<T1, T2, T3, T4, T5, T6>(this global::Xabbo.Messages.IPacket p)
    {
        global::Xabbo.Messages.PacketReader r = p.Reader();
        return (
    ...
    /// <summary>
    /// Reads 7 values of the specified types from the current position in the packet.
    /// </summary>
    public static (T1, T2, T3, T4, T5, T6, T7) Read<T1, T2, T3, T4, T5, T6, T7>(this global::Xabbo.Messages.IPacket p)
    {
        global::Xabbo.Messages.PacketReader r = p.Reader();
        return (
            Read<T1>(in r), Read<T2>(in r), Read<T3>(in r), Read<T4>(in r), Read<T5>(in r), 
    ...
    /// <summary>
    /// Reads 9 values of the specified types from the current position in the packet.
    /// </summary>
    ...
    /// <summary>
    /// Reads 10 values of the specified types from the current position in the packet.
    /// </summary>
    public static (T1, T2, T3, T4, T5, T6, T7, T8, T9, T10) Read<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10>(this global::Xabbo.Messages.IPacket p)
    {
        global::Xabbo.Messages.PacketReader r = p.Reader();
        return (
            Read<T1>(in r), Read<T2>(in r), Read<T3>(in r), Read<T4>(in r), Read<T5>(in r), 
